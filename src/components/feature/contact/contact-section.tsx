...
export default function ContactSection() {
  ...
  return (
    <section className="relative py-16 md:py-24 bg-background text-foreground">
      <div className="content relative max-w-7xl px-6 md:px-12 mx-auto ">
        <h2 className="font-heading text-2xl text-gray-100 mb-16">
          {tContact("information.title")}
        </h2>{" "}
        <div className="flex gap-16 flex-col-reverse md:flex-row">
